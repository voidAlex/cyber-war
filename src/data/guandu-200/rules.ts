...
export const guanduRules: CampaignRules = {
  ...
  aiRoles: [
    ...
    // ============================================================
    // 第 2+3 批新增：谋士（staff）/ 后勤官（logistics）纯对话角色
    // ============================================================
    // === 曹军谋士：郭嘉（算无遗策，善出奇谋） ===
    // 史实：郭嘉字奉孝，曹操首席谋士。"十胜十败"论定曹军必胜信心，预言孙策必死于刺客。
    // 官渡前已病亡（207 北征乌桓归途病逝），但作为曹方谋士精神象征纳入角色 tab。
    {
      id: 'ai-guojia-staff',
      type: 'staff',
      factionId: 'caocao',
      displayName: '郭嘉',
      personality:
        '曹军首席谋士，字奉孝，算无遗策、善出奇谋。"十胜十败"论为曹操定必胜信心，' +
        '预言孙策必死于刺客（后应验）。深谙敌我长短，善抓战机、出奇制胜。' +
        '在角色 tab 中提供战术建议（奇袭/分兵/反间），影响玩家决策。',
      aggression: 0.7,
      obedience: 0.9,
    },
    // === 曹军后勤官：荀彧（足食足兵，大后方总管） ===
    // 史实：荀彧字文若，曹操留守许都的"萧何"。坐镇后方督办粮草军械、举荐人才（郭嘉/荀攸）。
    {
      id: 'ai-xunyu-logistics',
      type: 'logistics',
      factionId: 'caocao',
      displayName: '荀彧',
      personality:
        '曹军大后方总管，字文若，足食足兵。坐镇许都督办粮草军械、举荐人才（郭嘉/荀攸/钟繇）。' +
        '曹操前线的"萧何"，保障官渡相持期间粮道不绝。在角色 tab 中解读后方粮草/军械态势、' +
        '补给脆弱点与持久战潜力。',
      aggression: 0.3,
      obedience: 0.9,
    },
    // === 袁军谋士：沮授（直言进谏，屡策不用） ===
    // 史实：沮授袁绍首席谋士，屡谏"缓进持重/分兵袭许/乌巢加固"，袁绍皆不听。
    // 后为曹操所擒，拒降殉主。悲剧性谋士，其建议若被采纳历史可能改写。
    {
      id: 'ai-jushou-staff',
      type: 'staff',
      factionId: 'yuanshao',
      displayName: '沮授',
      personality:
        '袁军首席谋士，直言进谏、屡策不用。主张"缓进持重耗曹军锐气"+"分兵袭许都劫天子"+"乌巢加固防奇袭"，' +
        '袁绍皆不听（史实乌巢果遭奇袭）。深谋远虑而遇暗主，悲剧性谋士。' +
        '在角色 tab 中提供战术建议（多为袁绍不用之良策），反映袁军决策失误。',
      aggression: 0.4,
      obedience: 0.6,
    },
  ],
